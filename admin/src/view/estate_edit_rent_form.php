<div class="card border-primary my-3">
    <div class="card-header text-center">
        <h2>แก้ไขข้อมูลที่ดินประเภท<strong class="badge badge-warning" style="font-size:1em;">เช่า</strong>ของคุณ!!</h2>
    </div>
    <div class="card-body">
        <form id="form-edit-estate" action="./src/model/estate_edit_func.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="border" id="preview" style="height: 250px; border-color:black;">
                            <div style="overflow: auto;height: 250px; font-size: 0px">
                                <div class="img_main_preview position-relative d-inline p-0 m-0" style="font-size: 0px">
                                    ...
                                    <img src="<?php echo "./src/img/estate/" . $details['img_estate_main']; ?>" class="img-to-upload col-lx-4 col-lg-4 col-md-6 col-sm-12 col-12 m-0 p-0" style="font-size: 0; height: 100%;" />
                                    <?php
                                    ?>
                                </div>
                                <div class="gallery d-inline p-0 m-0" style="font-size: 0px">
                                    <?php
                                    $gallery = explode(",", $details['img_estate']);
                                    foreach ($gallery as $img) {
                                    ?>
                                        <img src="<?php echo "./src/img/estate/" . $img; ?>" class="img-to-upload col-lx-4 col-lg-4 col-md-6 col-sm-12 col-12 m-0 p-0" style="font-size: 0; height: 100%;">
                                    <?php
                                    }
                                    ?>
                                </div>
            ...
            <div class="text-right">
                ...
                <a type="submit" class="btn btn-info btn-save-record-estate-rent text-light text-uppercase">submit</a>
