<div class="card border-primary my-3">
    <div class="card-header text-center">
        <h2>สร้างข้อมูลอาคารประเภทเช่า-ขายของคุณ!!</h2>
    </div>
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="form-inline">
                    ...
                    <input type="text" class="form-control price_building_sale border-primary ml-2" name="price_building_sale">
                </div>
            </div>
            <div class="form-group">
                <div class="form-inline">
                    <label class="mr-2" for="">ราคาเริ่มต้น</label>
                    <input type="text" class="form-control price_building_minimum border-primary" name="price_building_mimimum">
