<div class="card border-primary my-3">
    <div class="card-header text-center">
        <h2>สร้างข้อมูลอาคารประเภท<strong class="badge badge-warning" style="font-size:1em;">เช่า-ขาย</strong>ของคุณ!!</h2>
    </div>
    <div class="card-body">
        <form id="form-new-building" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="form-inline">
                    ...
                    <input type="text" class="form-control price_building_sale border-primary" name="price_building_sale">
                </div>
            </div>
            <div class="form-group">
                <div class="form-inline">
                    <label class="mr-2" for="">ราคาเริ่มต้น</label>
                    <input type="text" class="form-control price_building_minimum border-primary mr-2" name="price_building_minimum">
            ...
            <div class="text-right">
                ...
                <a type="submit" class="btn btn-info btn-create-new-record-building-rentandsale text-light text-uppercase">submit</a>
