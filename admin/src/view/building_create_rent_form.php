<div class="card border-primary my-3">
    <div class="card-header text-center">
        <h2>สร้างข้อมูลอาคารประเภท<strong class="badge badge-warning" style="font-size:1em;">เช่า</strong>ของคุณ!!</h2>
    </div>
    <div class="card-body">
        ...
        <div class="text-right">
            ...
            <a type="submit" href="javascript:void(0)" class="btn btn-info btn-create-new-record-building-rent text-light text-uppercase">submit</a>

            <!-- <button type="submit" class="btn btn-info btn-create-new-record-building-rent text-light text-uppercase">submit</button> -->
