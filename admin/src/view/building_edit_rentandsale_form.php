    ...
    <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control description_building border-primary" value="" name="description_building" style="width:100%;height:250px"><?php echo $details['description_building']; ?></textarea>
            </div>
            <div class="form-group">
