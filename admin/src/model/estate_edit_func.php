<?php
    ...
    if($_POST['id_estate']){
        ...
        $q_edit_detail_estate= "UPDATE estate SET title_estate = '$title_estate', price_estate = '$price_estate', description_estate = '$description_estate', location_estate = '$location_estate' WHERE id_estate = '$id_estate'";
