...
//  if(isset($_POST["submit_new_building"])){
     ...
     $q_new_building = "INSERT INTO building (id_building ,title_building ,img_building ,price_building ,description_building ,amenity_building ,location_building ,date_update) VALUES ('' ,'$title_building' ,'$img_building', '$price_building', '$description_building', '$amenity_building', '$location_building',NOW())";
