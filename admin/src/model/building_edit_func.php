<?php
    ...
    if($_POST['id_building']){
        ...
        $q_edit_detail_building = "UPDATE building SET title_building = '$title_building', price_building = '$price_building', description_building = '$description_building', location_building = '$location_building', map_building = '$map_building' WHERE id_building = '$id_building'";
