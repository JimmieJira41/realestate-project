    ...
    <div class="container">
        ...
        <div id="show-submit-data" class="modal" style="visibility: hidden;">
            <div class="content">
                ...
                <a href="javascript:$('#show-submit-data').css('visibility', 'hidden')" class="close"><i class="material-icons">close</i></a>
            </div>
        </div>
        <!-- Optional JavaScript -->
        ...
        <script type="text/javascript" src="https://code.jquery.com/jquery-3.2.1.min.js" integrity="sha256-hwg4gsxgFZhOsEEamdOYGBf13FyQuiTwlAQgxVSNgt4=" crossorigin="anonymous"></script>
        <script type="text/javascript" src="./src/js/image-uploader.min.js"></script>
        <!-- <script type="text/javascript" src="./src/js/image-uploader.min.js"></script> -->
        <script>
            $(function() {
