            ...
            <div class="form-group col-12 float-left">
                <div class="row">
                    ...
                    ?>
                        ...
                        ?>
                            <div class="col-4">
                                <a class="btn btn-primary" href="building_sale_page.php?building_select_option=<?php echo $row_list_type['id_type']; ?>&title_type=<?php echo $row_list_type['title_type']; ?>" style="width:100%"><?php echo $row_list_type['title_type']; ?></a>
                            </div>
                        <?php
                        } else if ($row_list_type['id_type'] == 3) {
                        ?>
                            <div class="col-4">
                                <a class="btn btn-primary" href="building_rentandsale_page.php?building_select_option=<?php echo $row_list_type['id_type']; ?>&title_type=<?php echo $row_list_type['title_type']; ?>" style="width:100%"><?php echo $row_list_type['title_type']; ?></a>
                            </div>
                        <?php
                        }
                        ?>
