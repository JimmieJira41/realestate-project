<?php
$q_fetch_estate_for_count = "SELECT * FROM estate";
$result_fetch_estate_for_count = mysqli_query($dbcon, $q_fetch_estate_for_count);
$total_row = mysqli_num_rows($result_fetch_estate_for_count);
