                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-12 col-12">
                            ...
                            if ($details['id_type'] == 1) {
                                if ($details['price_building_minimum'] == 0 && $details['price_building_maximum'] == 0) {
                                    echo "<p class='px-3 text-left' style='color:green'>ราคาเช่า กรุณาติดต่อเจ้าหน้าที่</p>";
                                } else if ($details['price_building_minimum'] != 0 and $details['price_building_maximum'] == 0) {
                                    echo "<p class='px-3 text-left' style='color:green'>ราคาเช่าเริ่มต้นที่ : " . $details['price_building_minimum'] . " บาทต่อเดือน</p>";
                                } else {
                                    echo "<p class='px-3 text-left' style='color:green'>ราคาเช่า : " . $details['price_building_minimum'] . " - " . $details['price_building_maximum'] . " บาทต่อเดือน</p>";
                                }
                                // echo "<p class='px-3' style='color:green'>ราคาเช่า : " . $details['price_building_minimum'] . " - " . $details['price_building_maximum'] . " บาทต่อเดือน</p>";
                            } else if ($details['id_type'] == 2) {
                                if ($details['price_building_sale'] == 0) {
                                    echo "<p class='px-3 text-left' style='color:green'>กรุณาติดต่อเจ้าหน้าที่</p>";
                                } else {
                                    echo "<p class='px-3 text-left' style='color:green'>ราคาขาย : " . $details['price_building_sale'] . " บาท</p>";
                                }
                                // echo "<p class='px-3 text-left' style='color:green'>ราคาขาย :  " . $details['price_building_sale'] . " บาท</p>";
                            } else {
                                if ($details['price_building_sale'] != 0) {
                                    echo "<p class='px-3 text-left' style='color:green'>ราคาขาย : " . $details['price_building_sale'] . " บาท</p>";
                                } else if ($details['price_building_sale'] == 0) {
                                    echo "<p class='px-3 text-left' style='color:green'>ราคาขาย กรุณาติดต่อเจ้าหน้าที่</p>";
                                }
                                if ($details['price_building_minimum'] == 0 && $details['price_building_maximum'] == 0) {
                                    echo "<p class='px-3 text-left' style='color:green'>กรุณาติดต่อเจ้าหน้าที่</p>";
                                } else if ($details['price_building_minimum'] != 0 && $details['price_building_maximum'] == 0) {
                                    echo "<p class='px-3 text-left' style='color:green'>ราคาเช่าเริ่มต้นที่ : " . $details['price_building_minimum'] . " บาทต่อเดือน</p>";
                                } else if ($details['price_building_minimum'] != 0 && $details['price_building_maximum'] != 0) {
                                    echo "<p class='px-3 text-left' style='color:green'>ราคาเช่า : " . $details['price_building_minimum'] . " - " . $details['price_building_maximum'] . " บาทต่อเดือน</p>";
                                } else if ($details['price_building_minimum'] == 0 && $details['price_building_maximum'] != 0) {
