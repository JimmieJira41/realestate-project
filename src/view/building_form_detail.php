                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-12 col-12">
                            ...
                            if ($details['id_type'] == 1) {
                                echo "<p class='pl-3' style='color:green'>ราคาเช่า : " . $details['price_building_minimum'] . " - " . $details['price_building_maximum'] . " บาทต่อเดือน</p>";
                            } else if ($details['id_type'] == 2) {
                                echo "<p class='pl-3' style='color:green'>ราคาขาย :  " . $details['price_building_sale'] . " บาท</p>";
                            } else {
                                echo "<p class='pl-3' style='color:green'>ราคาขาย : " . $details['price_building_sale'] . " บาท</p>" .
                                    "<p class='pl-3' style='color:green'>ราคาเช่า : " . $details['price_building_minimum'] . " - " . $details['price_building_maximum'] . " บาทต่อเดือน</p>";
                            }
