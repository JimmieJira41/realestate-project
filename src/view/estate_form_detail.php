...
<div class="card mt-2">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-12 col-12 border-right">
                        ...
                        if ($details['id_type'] == 1) {
                            echo "<p class='pl-3' style='color:green'>ราคาขาย " . $details['price_estate_minimum'] . " - " . $details['price_estate_maximum'] . " บาทต่อเดือน</p>";
                        } else if ($details['id_type'] == 2) {
                            echo "<p class='pl-3' style='color:green'>ราคาเช่า " . $details['price_estate_sale'] . " บาท</p>";
                        } else {
